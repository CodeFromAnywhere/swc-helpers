...
/**
 */
export interface TsConfig extends OrmItem {
    include?: string[];
    exclude?: string[];
    compilerOptions: CompilerOptions;
}
export declare const tsConfigConfig: {
    readonly modelName: "TsConfig";
    readonly isSingle: true;
    readonly storageLocation: "packages/[packageCategory]/[packageName]/tsconfig.json";
