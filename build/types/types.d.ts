...
export declare const swcStatementConfig: {
    readonly modelName: "SwcStatement";
    readonly storageLocation: "packages/[packageCategory]/[packageName]/statements.json";
 ...
 */
export type SwcFunction = OrmItem & TsStatement & {
    /**
...
export type SwcVariable = OrmItem & TsStatement & {
    statement?: any;
};
