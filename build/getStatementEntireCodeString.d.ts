...
*/
export declare const getStatementEntireCodeString: (operations: {
    [key: string]: string;
}, statementNames: string[]) => Promise<string | undefined>;
//# sourceMappingURL=getStatementEntireCodeString.d.ts.map