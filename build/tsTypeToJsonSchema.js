...
export const tsKeywordTypeKindToJsonSchemaTypeName = (tsKeywordTypeKind) => {
...
*/
export const tsTypeToJsonSchema = (typeAnnotation, references) => {
    ...
    const isPromise = typeAnnotation.type === "TsTypeReference" &&
    ...
    if (typeAnnotation.type === "TsTypeReference") {
        ...
        const reference = typeAnnotation.typeName.value;
    ...
    if (typeAnnotation.type === "TsTypeLiteral") {
        ...
        const propertiesArray = typeAnnotation.members
            ...
            const result = tsTypeToJsonSchema(item.typeAnnotation.typeAnnotation, []);
            return {
...
//# sourceMappingURL=tsTypeToJsonSchema.js.map