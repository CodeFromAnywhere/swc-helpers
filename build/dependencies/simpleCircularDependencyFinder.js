...
/**
   ...
   */
export const simpleCircularDependencyFinderRecursive = async (operations, dependenciesPerOperationLeft, stack) => {
    const dependenciesPerOperation = dependenciesPerOperationLeft ||
    ...
    const prunedDependenciesPerOperation = dependenciesPerOperation
        ...
        dependencies: item.dependencies?.filter((x) => x !== noDependenciesOperation.operationName),
    }));
    ...
    return simpleCircularDependencyFinderRecursive(operations, prunedDependenciesPerOperation, stack);
};
//# sourceMappingURL=simpleCircularDependencyFinder.js.map