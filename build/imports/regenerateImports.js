 ...
 */
export const regenerateImports = async (operations, 
/**
...
map, isDryrun) => {
    ...
    const result = await mapMany(Object.keys(groupedImportsPerFile), async (absolutePath, index) => {
        ...
        const { prettierError, newSrc } = await getNewSrc(src, oldImports, newImports);
        ...
        const changes = isDifferent && newSrc ? diffLines(src, newSrc) : undefined;
...
//# sourceMappingURL=regenerateImports.js.map