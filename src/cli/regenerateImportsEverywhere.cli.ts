...
if (basePath === undefined || basePath === "") {
  console.log(
    "Please provide a specific path. This is a very dangerous function",
  );
  process.exit();
}
...
const operations = {};
regenerateImportsEverywhere(operations, realBasePath, isDryrun).then((result) =>
  writeToAssets(__filename, result, "resulted-changes.json"),
);
